...
final class RouteHistoryFinishedCanceledCell: UITableViewCell {
    ...
    private func setupSubviews() {
        let background: UIView = {
            ...
            view.pinTo(contentView, leading: 25, top: 10, trailing: -25, bottom: -10)
...
//            destination.widthAnchor.constraint(equalTo: source.widthAnchor).isActive = true
        ...
        busySeatCount = {
            ...
            busySeatCount.text = "Զբաղված նստատեղեր - 4"
        ...
        pricePerPerson = {
            ...
            pricePerPerson.text = "500 Դ/անձը"
